...
function ServicesHero() {
  return (
    <section style={{position:"relative",minHeight:"55vh",display:"flex",alignItems:"center",justifyContent:"center",textAlign:"center",padding:"10rem 4rem 6rem",overflow:"hidden",borderBottom:`1px solid ${G.border}`}}>
      {/* animated bg grid */}
      <svg style={{position:"absolute",inset:0,width:"100%",height:"100%",opacity:.18}} xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="sgrid" width="60" height="60" patternUnits="userSpaceOnUse">
            <path d="M 60 0 L 0 0 0 60" fill="none" stroke={G.accent} strokeWidth="0.4"/>
          </pattern>
        </defs>
      ...
      <div style={{position:"relative",zIndex:2}}>
        ...
        <h1 style={{fontSize:"clamp(3rem,7vw,6rem)",fontWeight:800,lineHeight:1,letterSpacing:"-.035em",marginBottom:"1.2rem",animation:"fadeUp .6s .1s both"}}>
          Our <span style={{background:`linear-gradient(100deg,${G.accent},${G.green})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",backgroundClip:"text"}}>Services</span>
        </h1>
        <p style={{fontSize:"clamp(.9rem,1.4vw,1.1rem)",color:G.muted,lineHeight:1.78,maxWidth:520,margin:"0 auto",animation:"fadeUp .6s .2s both"}}>
          End-to-end digital solutions — from strategy and design to engineering and deployment. Everything your product needs to succeed.
        </p>
      </div>
    </section>
  );
